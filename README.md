...
账号端口、密码不变，切换节点（节点=服务器=IP=xx.xx.xx.xx)，普通用户换普通节点、精品用户换精品。换后重开连接开关，过30秒钟，重启浏览器测试。**不同的节点相当于不同的车道。**

###  警告 ！！

1. 代理程序不要长时间开启，不用就关掉，尤其手机用户不要连着程序上微信、支付宝等国产软件，这种情况断连后重启设备，过 5 分钟再试！
2. 用户电脑、手机装有任何国产杀毒软件、浏览器。影响程序正常运行，概不提供售后服务。
3. 如果你的账号借给他人使用，概不负责。
4. 尽量避免使用国产品牌手机，尤其是华为、小米。
...
**其他节点，见自己账号图上地址 or 下方的更新记录⬇️⬇️⬇️**
